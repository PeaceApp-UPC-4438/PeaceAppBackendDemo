namespace PeaceApp.API.Citizen.Domain.Model.Commands
{
    public record CreateCitizenAccountCommand
    {
        ...
        public CreateCitizenAccountCommand(string firstName, string lastName, string email, string street, string number, string city, string postalCode, string country)
        {
